...
<head>
    ...
    <link rel="stylesheet" href="KaryaAdmin.css">
    <style>
        ...
        <form class="toolbar" method="get" action="">
            ...
            <div class="toolbar-right">
                <div class="toolbar-right-top">
                    <a href="export_karya.php?q=<?php echo urlencode($search); ?>&kategori=<?php echo $filterKategori; ?>" class="btn-export" style="text-decoration: none; cursor: pointer;">
