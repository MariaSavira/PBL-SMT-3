    ...
    <main class="content" id="content">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                <?php if ($total === 0): ?>
                    <tr><td colspan="9" class="no-data">Belum ada data.</td></tr>
                ...
                <?php else: ?>
                    <?php while($row = pg_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td>
                                <?php 
                                    $r = json_decode($row['riset'], true);
                                    echo htmlspecialchars(is_array($r) ? implode(", ", $r) : $row['riset']);
                                ?>
                            </td>
                            ...
                            <td class="table-actions">
                                <a href="tambah_edit.php?id=<?= $row['id_publikasi'] ?>" class="action-edit">Edit</a>
                                <a href="hapus.php?id=<?= $row['id_publikasi'] ?>" class="action-delete"
